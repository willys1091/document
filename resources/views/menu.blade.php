...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	<a href="#" class="brand-link">
		<img src="{{env('assets')}}img/logo.png" alt="Butuh Uang" class="brand-image img-circle bg-light elevation-3" style="opacity: .8">
		<span class="brand-text font-weight-light">Butuh Uang</span>
	</a>
	<div class="sidebar">
		<nav class="mt-2">
            ...
            <li class="nav-item">
				<a href="{{url('content')}}" class="nav-link {{request()->segment(1)=='content'?"active":""}}">
					<i class="nav-icon fas fa-desktop"></i><p>Content</p>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{url('blog')}}" class="nav-link {{request()->segment(1)=='blog'?"active":""}}">
					<i class="nav-icon fas fa-blog"></i><p>Blog</p>
				</a>
			</li>
			<li class="nav-item">
				<a href="{{url('contact')}}" class="nav-link {{request()->segment(1)=='contact'?"active":""}}">
					<i class="nav-icon fas fa-address-book"></i><p>Contact</p>
				</a>
            </li>
			<li class="nav-header">Transaction</li>
            <li class="nav-item">
				<a href="{{url('transaction')}}" class="nav-link {{request()->segment(1)=='transaction'?"active":""}}">
					<i class="nav-icon fas fa-money-bill"></i><p>Transaction</p>
				</a>
			</li>
